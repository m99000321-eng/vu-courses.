...
export async function ensureCleanProductionData() {
  ...
  // Production must preserve real accounts and real course data.
  // Do not automatically delete students, instructors, courses, or related records.
  try {
    ...
    console.error('Production admin normalization failed:', error)
  }
}
